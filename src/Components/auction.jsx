              ...
              <div className="flex flex-col justify-center flex-1 px-6 py-8">
                ...
                <div className="flex justify-between">
                  <div>
                    ...
                    <h1 className="text-base mt-0 pt-0 font-medium text-center text-white   lg:text-[12px]">
                      44
                    </h1>
                  </div>
                  <div>
                ...
                <h1 className="text-2xl mt-2 font-bold  text-white   lg:text-[18px]">
                  Arts
                </h1>
                <div class="flex items-center mt-2">
                  ...
                  />
                  <div class="ml-4">
                    <p class="text-base font-medium text-white">Jenny Wilson</p>
                  </div>
                </div>
                <div className="flex mt-2 justify-between">
                  <h1 className="text-2xl  font-medium text-center text-white   lg:text-[12px]">
                    2.3 BNB
                  </h1>
                  <h1 className="text-2xl  pt-0 font-medium text-center text-white   lg:text-[12px]">
                    1 of 1
                  </h1>
                </div>
              </div>
